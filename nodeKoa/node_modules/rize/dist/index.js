...
class Rize extends infrastructure_1.default {
    /**
    ...
    constructor(options = {}) {
        ...
        void (() => __awaiter(this, void 0, void 0, function* () {
            ...
            this._browser = options.browser || (yield puppeteer_1.default.launch(options));
            this.preservePage = (yield this.browser.pages())[0];
            this.pages.push({ name: 'default', page: yield this.browser.newPage() });
